        ...
        <div className='fixed h-screen w-screen flex flex-col md:flex-row justify-center'>
            ...
            <div className="h-full w-full md:w-1/2 flex flex-col items-center order-1 md:order-2 fixed mt-4 mb-4">
                ...
                <div className="w-px bg-black relative left-1/3 flex items-center h-40">
                    <div className="ml-6 p-4 rounded-md flex items-center bg-gradient-to-br from-black via-pink-950 to-pink-700" style={{ minWidth: '300px', width: 'fit-content' }}>
                    ...
                    <div className="w-6 h-6 rounded-full bg-black absolute left-1/2 transform -translate-x-1/2"></div> {/* Circle for Vesit */}
                </div>
                <div className="w-px bg-black relative left-1/3 flex items-center h-40">
                    <div className="ml-6 p-4 rounded-md flex items-center bg-gradient-to-br from-black via-pink-950 to-pink-700" style={{ minWidth: '300px', width: 'fit-content' }}>
                        <div className="w-24 h-24 mr-4 shadow-xl rounded-full overflow-hidden flex-shrink-0">
                    ...
                    <div className="w-6 h-6 rounded-full bg-black absolute left-1/2 transform -translate-x-1/2"></div> {/* Circle for JP */}
                </div>
                <div className="w-px bg-black relative left-1/3 flex items-center h-32" >
                    <div className="ml-6 flex items-center" style={{ minWidth: '300px', width: 'fit-content' }}>
                        <div className="flex flex-col flex-grow">
                    ...
                    <div className="w-6 h-6 rounded-full bg-black absolute left-1/2 transform -translate-x-1/2"></div> {/* Circle for Position 1 */}
                </div>
                <div className="w-px bg-black relative left-1/3 flex items-center h-32">
                    <div className="ml-6 flex items-center" style={{ minWidth: '300px', width: 'fit-content' }}>
                        <div className="flex flex-col flex-grow">
                    ...
                    <div className="w-6 h-6 rounded-full bg-black absolute left-1/2 transform -translate-x-1/2"></div> {/* Circle for Position 2 */}
                </div>
            </div>
        </div>
