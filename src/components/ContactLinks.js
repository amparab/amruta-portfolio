    ...
    <div id="form" className="h-full w-full md:w-1/2 flex flex-col justify-center items-center mt-8 md:mt-16">
        ...
        <form className="w-full max-w-sm">
            <div className="flex flex-col mt-4 px-10">
                ...
                <input type="text" id="name" name="name" className="py-2 px-3 md:px-4 bg-white border-2 border-black rounded-md mt-2" />
            </div>
            <div className="flex flex-col mt-4 px-10">
                <label htmlFor="email" className="font-knuckleslite text-white">Email ID:</label>
                <input type="email" id="email" name="email" className="py-2 px-3 md:px-4 bg-white border-2 border-black rounded-md mt-2" />
            </div>
            <div className="flex flex-col mt-4 px-10">
                <label htmlFor="message" className="font-knuckleslite text-white">Message:</label>
                <textarea id="message" name="message" rows="4" className="py-2 px-3 md:px-4 bg-white border-2 border-black rounded-md mt-2"></textarea>
            </div>
