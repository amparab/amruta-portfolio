        ...
        <>
            {
                <div className="fixed inset-0 p-5 flex flex-col justify-center items-center" ref={skillsRef}>
                    {skills && <div id="skillsContainer" className="text-white text-center" style={{ maxHeight: '200vh' }}>
                        <div id="skills-title" className="text-3xl md:text-5xl font-knuckles my-4 md:my-8">
                            <ReactTyped strings={["MY SKILLS"]} typeSpeed={50} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-16">
                            <div>
                                <div className='py-4'>
                                    <div className="text-xl md:text-2xl font-knuckleslite">Technologies</div>
                            ...
                            <div>
                                <div className='py-4'>
                                    <div className="text-xl md:text-2xl font-knuckleslite">Concepts</div>
                                    <hr className="border-t-1 border-gray-300 my-1" />
                                </div>
                                <div className="grid grid-cols-2 gap-x-8">
                                    <div className="text-base md:text-lg font-knuckleslite text-right">
                            ...
                            <div>
                                <div className='py-4'>
                                    <div className="text-xl md:text-2xl font-knuckleslite">Tools</div>
                                    <hr className="border-t-1 border-gray-300 my-1" />
                                </div>
