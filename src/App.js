    ...
    <>
      ...
      :
        ...
        <div id="container" onWheel={handleWheel} className="h-screen w-screen flex flex-col justify-center items-center">
          ...
          {showIntro && <div id="intro" className="z-0 h-screen w-full  fixed">
          <h1 className='fixed text-3xl md:text-5xl font-pixel mt-6 items-center justify-center'>
          ...
          {showIntro && <div id="intro" className="z-0 h-screen w-full flex flex-col items-center justify-center">
          <h1 className='fixed text-3xl md:text-5xl font-pixel mt-6'>
